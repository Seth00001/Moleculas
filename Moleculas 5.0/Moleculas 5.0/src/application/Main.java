...
//		IntegrityDataCollector col = new IntegrityDataCollector(grid);
//		
//		ArrayList<LayerDataHandler> hwd = col.CollectPerLayerInvertedData(Direction.X);
//		LayerDataHandler d = col.GetLayerData(0, Direction.X);
//		
//		
//		for(int i = 0; i < d.data.size(); i++) {
//			System.out.println(d.data.get(i).size());
//		}
//		
